...
// fun simple_lp::withdraw [baseline] at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:28:1+618
procedure {:inline 1} $0_simple_lp_withdraw'#0'$impl(_$t0: $Mutation ($0_simple_lp_Pool'#0'), _$t1: $2_balance_Balance'$0_simple_lp_LP'#0'') returns ($ret0: $2_balance_Balance'#0', $ret1: $Mutation ($0_simple_lp_Pool'#0'))
{
    // declare local variables
    var $t2: int;
    var $t3: int;
    ...
    var $t12: $2_balance_Balance'#0';
    var $t13: int;
    var $t14: $2_balance_Supply'$0_simple_lp_LP'#0'';
    var $t15: int;
    var $t16: int;
    var $t17: int;
    var $t18: int;
    ...
    var $t22: int;
    var $t23: int;
    var $t24: $Mutation ($2_balance_Supply'$0_simple_lp_LP'#0'');
    var $t25: int;
    var $t26: int;
    var $t27: bool;
    var $t28: $Mutation ($2_balance_Balance'#0');
    var $t29: $2_balance_Balance'#0';
    ...
    // bytecode translation starts here
    // trace_local[pool]($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:28:1+1
    assume {:print "$at(232,594,595)"} true;
    $temp_0'$0_simple_lp_Pool'#0'' := $Dereference($t0);
    assume {:print "$track_local(139,1,0,$0_simple_lp_Pool'#0'):", $temp_0'$0_simple_lp_Pool'#0''} $temp_0'$0_simple_lp_Pool'#0'' == $temp_0'$0_simple_lp_Pool'#0'';

    // trace_local[shares_in]($t1) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:28:1+1
    assume {:print "$track_local(139,1,1,$2_balance_Balance'$0_simple_lp_LP'#0''):", $t1} $t1 == $t1;

    // $t6 := balance::value<simple_lp::LP<#0>>($t1) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:29:9+17
    assume {:print "$at(232,686,703)"} true;
    call $t6 := $2_balance_value'$0_simple_lp_LP'#0''($t1);
    if ($abort_flag) {
        assume {:print "$at(232,686,703)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t8 := 0 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:29:30+1
    $t8 := 0;
    assume $IsValid'u64'($t8);

    // $t9 := ==($t6, $t8) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:29:27+2
    $t9 := $IsEqual'u64'($t6, $t8);

    // if ($t9) goto L1 else goto L0 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:29:5+91
    if ($t9) { goto L1; } else { goto L0; }

    // label L1 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:30:9+24
    assume {:print "$at(232,720,744)"} true;
L1:

    // destroy($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:30:9+24
    assume {:print "$at(232,720,744)"} true;

    // balance::destroy_zero<simple_lp::LP<#0>>($t1) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:30:9+24
    call $2_balance_destroy_zero'$0_simple_lp_LP'#0''($t1);
    if ($abort_flag) {
        assume {:print "$at(232,720,744)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
    ...
    // $t10 := balance::zero<#0>() on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:31:16+6
    assume {:print "$at(232,761,767)"} true;
    call $t10 := $2_balance_zero'#0'();
    if ($abort_flag) {
        assume {:print "$at(232,761,767)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
    ...
    // trace_return[0]($t10) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:31:9+13
    assume {:print "$track_return(139,1,0,$2_balance_Balance'#0'):", $t10} $t10 == $t10;

    // trace_local[pool]($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:31:9+13
    $temp_0'$0_simple_lp_Pool'#0'' := $Dereference($t0);
    assume {:print "$track_local(139,1,0,$0_simple_lp_Pool'#0'):", $temp_0'$0_simple_lp_Pool'#0''} $temp_0'$0_simple_lp_Pool'#0'' == $temp_0'$0_simple_lp_Pool'#0'';

    // $t11 := move($t10) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:31:9+13
    $t11 := $t10;

    // goto L4 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:31:9+13
    goto L4;

    // label L0 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:34:19+4
    assume {:print "$at(232,794,798)"} true;
L0:

    // $t12 := get_field<simple_lp::Pool<#0>>.balance($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:34:19+12
    assume {:print "$at(232,794,806)"} true;
    $t12 := $Dereference($t0)->$balance;

    // $t13 := balance::value<#0>($t12) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:34:19+20
    call $t13 := $2_balance_value'#0'($t12);
    if ($abort_flag) {
        assume {:print "$at(232,794,814)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // trace_local[balance#1#0]($t13) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:34:9+7
    assume {:print "$track_local(139,1,2,u64):", $t13} $t13 == $t13;

    // $t14 := get_field<simple_lp::Pool<#0>>.shares($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:35:18+11
    assume {:print "$at(232,833,844)"} true;
    $t14 := $Dereference($t0)->$shares;

    // $t15 := balance::supply_value<simple_lp::LP<#0>>($t14) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:35:18+26
    call $t15 := $2_balance_supply_value'$0_simple_lp_LP'#0''($t14);
    if ($abort_flag) {
        assume {:print "$at(232,833,859)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // trace_local[shares#1#0]($t15) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:35:9+6
    assume {:print "$track_local(139,1,4,u64):", $t15} $t15 == $t15;

    // $t16 := balance::value<simple_lp::LP<#0>>($t1) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:36:27+17
    assume {:print "$at(232,887,904)"} true;
    ...
    // trace_local[shares_in_value#1#0]($t16) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:36:9+15
    assume {:print "$track_local(139,1,5,u64):", $t16} $t16 == $t16;

    // $t17 := balance::value<simple_lp::LP<#0>>($t1) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:39:12+17
    assume {:print "$at(232,948,965)"} true;
    call $t17 := $2_balance_value'$0_simple_lp_LP'#0''($t1);
    if ($abort_flag) {
        assume {:print "$at(232,948,965)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
    ...
    // $t18 := (u128)($t17) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:39:12+25
    $t18 := $t17;
    assume $t18 <= $MAX_U128;if ($abort_flag) {
        assume {:print "$at(232,948,973)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t19 := (u128)($t13) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:39:42+15
    $t19 := $t13;
    assume $t19 <= $MAX_U128;if ($abort_flag) {
        assume {:print "$at(232,978,993)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t20 := *($t18, $t19) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:39:39+1
    call $t20 := $MulU128($t18, $t19);
    if ($abort_flag) {
        assume {:print "$at(232,975,976)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t21 := (u128)($t15) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:39:63+14
    $t21 := $t15;
    assume $t21 <= $MAX_U128;if ($abort_flag) {
        assume {:print "$at(232,999,1013)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t22 := /($t20, $t21) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:39:60+1
    call $t22 := $Div($t20, $t21);
    if ($abort_flag) {
        assume {:print "$at(232,996,997)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // $t23 := (u64)($t22) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:39:9+77
    call $t23 := $CastU64($t22);
    if ($abort_flag) {
        assume {:print "$at(232,945,1022)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // trace_local[balance_to_withdraw#1#0]($t23) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:38:9+19
    assume {:print "$at(232,915,934)"} true;
    assume {:print "$track_local(139,1,3,u64):", $t23} $t23 == $t23;

    // $t24 := borrow_field<simple_lp::Pool<#0>>.shares($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:41:5+11
    assume {:print "$at(232,1029,1040)"} true;
    $t24 := $ChildMutation($t0, 2, $Dereference($t0)->$shares);

    // $t25 := balance::decrease_supply<simple_lp::LP<#0>>($t24, $t1) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:41:5+38
    call $t25,$t24 := $2_balance_decrease_supply'$0_simple_lp_LP'#0''($t24, $t1);
    if ($abort_flag) {
        assume {:print "$at(232,1029,1067)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // write_back[Reference($t0).shares (balance::Supply<simple_lp::LP<#0>>)]($t24) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:41:5+38
    $t0 := $UpdateMutation($t0, $Update'$0_simple_lp_Pool'#0''_shares($Dereference($t0), $Dereference($t24)));

    // trace_local[pool]($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:41:5+38
    $temp_0'$0_simple_lp_Pool'#0'' := $Dereference($t0);
    assume {:print "$track_local(139,1,0,$0_simple_lp_Pool'#0'):", $temp_0'$0_simple_lp_Pool'#0''} $temp_0'$0_simple_lp_Pool'#0'' == $temp_0'$0_simple_lp_Pool'#0'';

    // destroy($t25) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:41:5+38

    // $t26 := 10000 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:43:28+21
    assume {:print "$at(232,1097,1118)"} true;
    $t26 := 10000;
    assume $IsValid'u64'($t26);

    // $t27 := >=($t16, $t26) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:43:25+2
    call $t27 := $Ge($t16, $t26);

    // if ($t27) goto L3 else goto L2 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:43:5+90
    if ($t27) { goto L3; } else { goto L2; }

    // label L3 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:44:9+27
    assume {:print "$at(232,1130,1157)"} true;
L3:

    // simple_lp::emit_large_withdraw_event() on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:44:9+27
    assume {:print "$at(232,1130,1157)"} true;
    call $0_simple_lp_emit_large_withdraw_event();
    if ($abort_flag) {
        assume {:print "$at(232,1130,1157)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
    ...
    // label L2 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:47:5+4
    assume {:print "$at(232,1171,1175)"} true;
L2:

    // $t28 := borrow_field<simple_lp::Pool<#0>>.balance($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:47:5+12
    assume {:print "$at(232,1171,1183)"} true;
    $t28 := $ChildMutation($t0, 1, $Dereference($t0)->$balance);

    // $t29 := balance::split<#0>($t28, $t23) on_abort goto L5 with $t7 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:47:5+39
    call $t29,$t28 := $2_balance_split'#0'($t28, $t23);
    if ($abort_flag) {
        assume {:print "$at(232,1171,1210)"} true;
        $t7 := $abort_code;
        assume {:print "$track_abort(139,1):", $t7} $t7 == $t7;
        goto L5;
    }

    // write_back[Reference($t0).balance (balance::Balance<#0>)]($t28) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:47:5+39
    $t0 := $UpdateMutation($t0, $Update'$0_simple_lp_Pool'#0''_balance($Dereference($t0), $Dereference($t28)));

    // trace_local[pool]($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:47:5+39
    $temp_0'$0_simple_lp_Pool'#0'' := $Dereference($t0);
    assume {:print "$track_local(139,1,0,$0_simple_lp_Pool'#0'):", $temp_0'$0_simple_lp_Pool'#0''} $temp_0'$0_simple_lp_Pool'#0'' == $temp_0'$0_simple_lp_Pool'#0'';

    // trace_return[0]($t29) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:47:5+39
    assume {:print "$track_return(139,1,0,$2_balance_Balance'#0'):", $t29} $t29 == $t29;

    // trace_local[pool]($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:47:5+39
    $temp_0'$0_simple_lp_Pool'#0'' := $Dereference($t0);
    assume {:print "$track_local(139,1,0,$0_simple_lp_Pool'#0'):", $temp_0'$0_simple_lp_Pool'#0''} $temp_0'$0_simple_lp_Pool'#0'' == $temp_0'$0_simple_lp_Pool'#0'';

    // $t11 := move($t29) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:47:5+39
    $t11 := $t29;

    // label L4 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:48:1+1
    assume {:print "$at(232,1211,1212)"} true;
L4:

    // return $t11 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:48:1+1
    assume {:print "$at(232,1211,1212)"} true;
    $ret0 := $t11;
    $ret1 := $t0;
    return;

    // label L5 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:48:1+1
L5:

    // abort($t7) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:48:1+1
    assume {:print "$at(232,1211,1212)"} true;
    $abort_code := $t7;
    $abort_flag := true;
    return;
...
// fun simple_lp::withdraw_spec [verification] at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:52:1+751
procedure {:timeLimit 3000} $0_simple_lp_withdraw'#0'$verify(_$t0: $Mutation ($0_simple_lp_Pool'#0'), _$t1: $2_balance_Balance'$0_simple_lp_LP'#0'') returns ($ret0: $2_balance_Balance'#0', $ret1: $Mutation ($0_simple_lp_Pool'#0'))
{
    // declare local variables
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:52:1+1
    assume {:print "$at(232,1309,1310)"} true;
    assume $IsValid'$0_simple_lp_Pool'#0''($Dereference($t0));

    // assume WellFormed($t1) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:52:1+1
    assume $IsValid'$2_balance_Balance'$0_simple_lp_LP'#0'''($t1);
    ...
    // prover::requires($t12) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:53:5+57
    ...
    call $t17,$t0 := $0_simple_lp_withdraw'#0'$impl($t0, $t1);
    if ($abort_flag) {
        assume {:print "$at(232,1598,1623)"} true;
        $t9 := $abort_code;
    ...
    // prover::ensures($t32) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:68:5+69
    assume {:print "$at(232,1862,1931)"} true;
    assert {:msg "assert_failed(232,1862,1931): prover::ensures does not hold"} $t32;
...
L1:
    ...
    // prover::ensures($t35) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:71:9+44
    assume {:print "$at(232,1994,2038)"} true;
    assert {:msg "assert_failed(232,1994,2038): prover::ensures does not hold"} $t35;
...
L2:
    ...
    assume {:print "$at(232,2059,2060)"} true;
    call $0_simple_lp_withdraw'#0'$asserts(_$t0, _$t1, $ghost_$global_var__'$0_simple_lp_LargeWithdrawEvent_bool');
    $ret0 := $t17;
    $ret1 := $t0;
    return;
...
L3:
    ...
    assume {:print "$at(232,2059,2060)"} true;
    $abort_flag := false;
    call $abort_if_cond := $0_simple_lp_withdraw'#0'$aborts(_$t0, _$t1, $ghost_$global_var__'$0_simple_lp_LargeWithdrawEvent_bool': bool);
    assert {:msg "assert_failed(232,1309,2060): prover::asserts conditions are not complete"} !$abort_if_cond;
    $abort_code := $t9;
    $abort_flag := true;
    return;
...
// fun simple_lp::withdraw_spec [baseline] at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:52:1+751
procedure {:inline 1} $0_simple_lp_withdraw'#0'$asserts(_$t0: $Mutation ($0_simple_lp_Pool'#0'), _$t1: $2_balance_Balance'$0_simple_lp_LP'#0'', $ghost_$global_var__'$0_simple_lp_LargeWithdrawEvent_bool': bool) returns ()
{
    // declare local variables
    var $t2: $1_integer_Integer;
    var $t3: $1_integer_Integer;
...
// fun simple_lp::withdraw_spec [verification] at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:52:1+751
procedure {:timeLimit 3000} $0_simple_lp_withdraw'#0'$spec_no_abort_check$verify(_$t0: $Mutation ($0_simple_lp_Pool'#0'), _$t1: $2_balance_Balance'$0_simple_lp_LP'#0'') returns ()
{
    // declare local variables
    var $t2: $1_integer_Integer;
    var $t3: $1_integer_Integer;
    ...
    // $t8 := balance::value<simple_lp::LP<#0>>($t1)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:53:14+17
    assume {:print "$at(232,1404,1421)"} true;
    call $t8 := $2_balance_value'$0_simple_lp_LP'#0''($t1);
    assert {:msg "assert_failed(232,1404,1421): spec code itself should not abort"} !$abort_flag;

    // $t10 := get_field<simple_lp::Pool<#0>>.shares($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:53:35+11
    assume {:print "$at(232,1425,1436)"} true;
    $t10 := $Dereference($t0)->$shares;

    // $t11 := balance::supply_value<simple_lp::LP<#0>>($t10)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:53:35+26
    call $t11 := $2_balance_supply_value'$0_simple_lp_LP'#0''($t10);
    assert {:msg "assert_failed(232,1425,1451): spec code itself should not abort"} !$abort_flag;

    // $t12 := <=($t8, $t11) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:53:32+2
    assume {:print "$at(232,1422,1424)"} true;
    call $t12 := $Le($t8, $t11);

    // prover::requires($t12)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:53:5+57
    call $0_prover_requires($t12);
    assert {:msg "assert_failed(232,1395,1452): spec code itself should not abort"} !$abort_flag;

    // $t13 := read_ref($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:57:25+4
    assume {:print "$at(232,1528,1532)"} true;
    $t13 := $Dereference($t0);

    // $t14 := prover::val<simple_lp::Pool<#0>>($t13)no_abort check at /Users/iftikharuddin/.move/https___github_com_asymptotic-code_sui-prover_git_main/packages/prover/sources/prover.move:59:9+7
    assume {:print "$at(4,964,971)"} true;
    call $t14 := $0_prover_val'$0_simple_lp_Pool'#0''($t13);
    assert {:msg "assert_failed(4,964,971): spec code itself should not abort"} !$abort_flag;

    // $t15 := prover::ref<simple_lp::Pool<#0>>($t14)no_abort check at /Users/iftikharuddin/.move/https___github_com_asymptotic-code_sui-prover_git_main/packages/prover/sources/prover.move:59:5+12
    assume {:print "$at(4,960,972)"} true;
    call $t15 := $0_prover_ref'$0_simple_lp_Pool'#0''($t14);
    assert {:msg "assert_failed(4,960,972): spec code itself should not abort"} !$abort_flag;

    // trace_local[old_pool#1#0]($t15) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:57:9+8
    assume {:print "$at(232,1512,1520)"} true;
    assume {:print "$track_local(139,2,4,$0_simple_lp_Pool'#0'):", $t15} $t15 == $t15;

    // $t16 := balance::value<simple_lp::LP<#0>>($t1)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:58:27+17
    assume {:print "$at(232,1561,1578)"} true;
    call $t16 := $2_balance_value'$0_simple_lp_LP'#0''($t1);
    assert {:msg "assert_failed(232,1561,1578): spec code itself should not abort"} !$abort_flag;

    // trace_local[shares_in_value#1#0]($t16) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:58:9+15
    assume {:print "$at(232,1543,1558)"} true;
    assume {:print "$track_local(139,2,7,u64):", $t16} $t16 == $t16;

    // $t17 := simple_lp::withdraw<#0>($t0, $t1) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:60:18+25
    assume {:print "$at(232,1598,1623)"} true;
    call $t17,$t0 := $0_simple_lp_withdraw'#0'$opaque($t0, $t1);
    ...
    // $t19 := balance::value<#0>($t18)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:62:23+24
    call $t19 := $2_balance_value'#0'($t18);
    assert {:msg "assert_failed(232,1648,1672): spec code itself should not abort"} !$abort_flag;

    // $t20 := integer::from_u64($t19)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:62:23+33
    assume {:print "$at(232,1648,1681)"} true;
    call $t20 := $1_integer_from_u64($t19);
    assert {:msg "assert_failed(232,1648,1681): spec code itself should not abort"} !$abort_flag;
    ...
    // $t22 := balance::value<#0>($t21)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:63:23+20
    call $t22 := $2_balance_value'#0'($t21);
    assert {:msg "assert_failed(232,1705,1725): spec code itself should not abort"} !$abort_flag;

    // $t23 := integer::from_u64($t22)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:63:23+29
    assume {:print "$at(232,1705,1734)"} true;
    call $t23 := $1_integer_from_u64($t22);
    assert {:msg "assert_failed(232,1705,1734): spec code itself should not abort"} !$abort_flag;
    ...
    // $t25 := balance::supply_value<simple_lp::LP<#0>>($t24)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:65:22+30
    call $t25 := $2_balance_supply_value'$0_simple_lp_LP'#0''($t24);
    assert {:msg "assert_failed(232,1758,1788): spec code itself should not abort"} !$abort_flag;

    // $t26 := integer::from_u64($t25)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:65:22+39
    assume {:print "$at(232,1758,1797)"} true;
    call $t26 := $1_integer_from_u64($t25);
    assert {:msg "assert_failed(232,1758,1797): spec code itself should not abort"} !$abort_flag;
    ...
    // $t28 := balance::supply_value<simple_lp::LP<#0>>($t27)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:66:22+26
    call $t28 := $2_balance_supply_value'$0_simple_lp_LP'#0''($t27);
    assert {:msg "assert_failed(232,1820,1846): spec code itself should not abort"} !$abort_flag;

    // $t29 := integer::from_u64($t28)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:66:22+35
    assume {:print "$at(232,1820,1855)"} true;
    call $t29 := $1_integer_from_u64($t28);
    assert {:msg "assert_failed(232,1820,1855): spec code itself should not abort"} !$abort_flag;

    // $t30 := integer::mul($t29, $t20)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:68:13+27
    assume {:print "$at(232,1870,1897)"} true;
    call $t30 := $1_integer_mul($t29, $t20);
    assert {:msg "assert_failed(232,1870,1897): spec code itself should not abort"} !$abort_flag;

    // $t31 := integer::mul($t26, $t23)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:68:45+27
    assume {:print "$at(232,1902,1929)"} true;
    call $t31 := $1_integer_mul($t26, $t23);
    assert {:msg "assert_failed(232,1902,1929): spec code itself should not abort"} !$abort_flag;

    // $t32 := integer::lte($t30, $t31)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:68:13+60
    assume {:print "$at(232,1870,1930)"} true;
    call $t32 := $1_integer_lte($t30, $t31);
    assert {:msg "assert_failed(232,1870,1930): spec code itself should not abort"} !$abort_flag;

    // prover::requires($t32)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:68:5+69
    assume {:print "$at(232,1862,1931)"} true;
    call $0_prover_requires($t32);
    assert {:msg "assert_failed(232,1862,1931): spec code itself should not abort"} !$abort_flag;
...
L1:
    ...
    // $t35 := ghost::global<simple_lp::LargeWithdrawEvent, bool>()no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:71:18+34
    assume {:print "$at(232,2003,2037)"} true;
    call $t35 := $0_ghost_global'$0_simple_lp_LargeWithdrawEvent_bool'();
    assert {:msg "assert_failed(232,2003,2037): spec code itself should not abort"} !$abort_flag;

    // prover::requires($t35)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/lp_move.move:71:9+44
    assume {:print "$at(232,1994,2038)"} true;
    call $0_prover_requires($t35);
    assert {:msg "assert_failed(232,1994,2038): spec code itself should not abort"} !$abort_flag;
