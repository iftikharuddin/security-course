...
// fun game::compute [baseline] at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:6:1+163
procedure {:inline 1} $2_game_compute$impl(_$t0: int) returns ($ret0: int)
{
    // declare local variables
    var $t1: int;
    var $t2: int;
    ...
    // bytecode translation starts here
    // trace_local[x]($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:6:1+1
    assume {:print "$at(231,75,76)"} true;
    assume {:print "$track_local(175,0,0,u64):", $t0} $t0 == $t0;

    // $t1 := 2 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:8:23+1
    assume {:print "$at(231,148,149)"} true;
    $t1 := 2;
    assume $IsValid'u64'($t1);

    // $t2 := *($t0, $t1) on_abort goto L2 with $t3 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:8:21+1
    call $t2 := $MulU64($t0, $t1);
    if ($abort_flag) {
        assume {:print "$at(231,146,147)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(175,0):", $t3} $t3 == $t3;
        goto L2;
    }

    // $t4 := 6 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:9:23+1
    assume {:print "$at(231,173,174)"} true;
    $t4 := 6;
    assume $IsValid'u64'($t4);

    // $t5 := +($t2, $t4) on_abort goto L2 with $t3 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:9:21+1
    call $t5 := $AddU64($t2, $t4);
    if ($abort_flag) {
        assume {:print "$at(231,171,172)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(175,0):", $t3} $t3 == $t3;
        goto L2;
    }

    // $t6 := 2 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:10:23+1
    assume {:print "$at(231,198,199)"} true;
    $t6 := 2;
    assume $IsValid'u64'($t6);

    // $t7 := /($t5, $t6) on_abort goto L2 with $t3 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:10:21+1
    call $t7 := $Div($t5, $t6);
    if ($abort_flag) {
        assume {:print "$at(231,196,197)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(175,0):", $t3} $t3 == $t3;
        goto L2;
    }

    // $t8 := -($t7, $t0) on_abort goto L2 with $t3 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:11:21+1
    assume {:print "$at(231,221,222)"} true;
    call $t8 := $Sub($t7, $t0);
    if ($abort_flag) {
        assume {:print "$at(231,221,222)"} true;
        $t3 := $abort_code;
    ...
    // trace_return[0]($t8) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:12:5+6
    assume {:print "$at(231,230,236)"} true;
    assume {:print "$track_return(175,0,0,u64):", $t8} $t8 == $t8;

    // label L1 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:13:1+1
    assume {:print "$at(231,237,238)"} true;
L1:

    // return $t8 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:13:1+1
    assume {:print "$at(231,237,238)"} true;
    $ret0 := $t8;
    return;

    // label L2 at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:13:1+1
L2:

    // abort($t3) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:13:1+1
    assume {:print "$at(231,237,238)"} true;
    $abort_code := $t3;
    $abort_flag := true;
    return;
