...
// fun game::compute_spec [verification] at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:16:1+200
procedure {:timeLimit 3000} $2_game_compute$verify(_$t0: int) returns ($ret0: int)
{
    // declare local variables
    var $t1: int;
    var $t2: int;
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:16:1+1
    ...
    // prover::requires($t3) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:18:5+45
    call $0_prover_requires($t3);
    ...
    call $t5 := $2_game_compute$impl($t0);
    if ($abort_flag) {
        assume {:print "$at(231,405,415)"} true;
        $t4 := $abort_code;
    ...
    // prover::ensures($t7) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:20:5+20
    assert {:msg "assert_failed(231,421,441): prover::ensures does not hold"} $t7;
...
L1:
    ...
    assume {:print "$at(231,454,455)"} true;
    call $2_game_compute$asserts(_$t0);
    $ret0 := $t5;
    return;
...
L2:
    ...
    assume {:print "$at(231,454,455)"} true;
    $abort_flag := false;
    call $abort_if_cond := $2_game_compute$aborts(_$t0);
    assert {:msg "assert_failed(231,255,455): prover::asserts conditions are not complete"} !$abort_if_cond;
    $abort_code := $t4;
    $abort_flag := true;
    return;
...
// fun game::compute_spec [baseline] at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:16:1+200
procedure {:inline 1} $2_game_compute$asserts(_$t0: int) returns ()
{
    // declare local variables
    var $t1: int;
    var $t2: int;
...
// fun game::compute_spec [verification] at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:16:1+200
procedure {:timeLimit 3000} $2_game_compute$spec_no_abort_check$verify(_$t0: int) returns ()
{
    // declare local variables
    var $t1: int;
    var $t2: int;
    ...
    // prover::requires($t3)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:18:5+45
    call $0_prover_requires($t3);
    assert {:msg "assert_failed(231,341,386): spec code itself should not abort"} !$abort_flag;

    // $t5 := game::compute($t0) at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:19:18+10
    assume {:print "$at(231,405,415)"} true;
    $t5 := $2_game_compute$opaque($t0);

    // $t5 := havoc[val]() at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:16:1+200
    assume {:print "$at(231,255,455)"} true;
    havoc $t5;
    ...
    // prover::requires($t7)no_abort check at /Users/iftikharuddin/PhpstormProjects/security-course/formal-verification-course/protocol_formal_verification/sources/game.move:20:5+20
    call $0_prover_requires($t7);
    assert {:msg "assert_failed(231,421,441): spec code itself should not abort"} !$abort_flag;
